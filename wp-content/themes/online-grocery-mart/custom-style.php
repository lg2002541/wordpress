<?php
	...
	if($food_grocery_store_color != false){
		$food_grocery_store_custom_css .='#footer .textwidget a, #sidebar .textwidget a, .woocommerce-product-details__short-description p a, .textwidget p a, .entry-content a, #sidebar p a, #comments p a, .comment-meta.commentmetadata a, #content-vw a,#footer li a:hover, .account i, .logo .site-title a:hover{';
	...
	if($food_grocery_store_color != false){
		$food_grocery_store_custom_css .='.main-navigation ul ul{';
	...
	if($food_grocery_store_second_color != false){
		$food_grocery_store_custom_css .='a, .wishlist i, .sticky .post-main-box h2:before, .top-bar p a:hover, .post-main-box:hover h2 a, .post-main-box:hover .post-info span a, .post-info:hover a, #comments a.comment-reply-link{';
