...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">		
			...
			<button class="tablinks" onclick="online_grocery_mart_open_tab(event, 'product_addons_editor')"><?php esc_html_e( 'Woocommerce Product Addons', 'online-grocery-mart' ); ?></button>
		...
		<div id="product_addons_editor" class="tabcontent">
			...
			<?php }else{ ?>
				<h3><?php esc_html_e( 'Woocommerce Products Blocks', 'online-grocery-mart' ); ?></h3>
				<hr class="h3hr">
				<div class="online-grocery-mart-pattern-page">
					<p><?php esc_html_e('Follow the below instructions to setup Products Templates.','online-grocery-mart'); ?></p>
					<p><b><?php esc_html_e('1. First you need to activate these plugins','online-grocery-mart'); ?></b></p>
						<p><?php esc_html_e('1. Ibtana - WordPress Website Builder ','online-grocery-mart'); ?></p>
						<p><?php esc_html_e('2. Ibtana - Ecommerce Product Addons.','online-grocery-mart'); ?></p>
						<p><?php esc_html_e('3. Woocommerce','online-grocery-mart'); ?></p>

	              	<div class="online-grocery-mart-pattern-page">
				    		<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-templates&woo=true&ive_wizard_view=parent' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','online-grocery-mart'); ?></a>
				    	</div>
			    </div>
			<?php } ?>
		</div>
