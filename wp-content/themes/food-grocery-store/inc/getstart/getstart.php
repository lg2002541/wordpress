			...
			<?php }else{ ?>
				...
				<div class="food-grocery-store-pattern-page">
					...
					<p><b><?php esc_html_e('1. First you need to activate these plugins','food-grocery-store'); ?></b></p>
	              	...
	              	<div class="food-grocery-store-pattern-page">
				    		<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-templates&ive_wizard_view=parent' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','food-grocery-store'); ?></a>
				    	</div>
			    </div>
			<?php } ?>
		</div>
